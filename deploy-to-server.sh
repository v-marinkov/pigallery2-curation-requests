...
DEPLOY_EXTENSION_DIR="${PG2_DEPLOY_EXTENSION_DIR:-${DEPLOY_BASE}/config/extensions/request-deletions}"
...
DEPLOY_CONTAINER_EXTENSION_DIR="${PG2_DEPLOY_CONTAINER_EXTENSION_DIR:-/app/data/config/extensions/request-deletions}"
